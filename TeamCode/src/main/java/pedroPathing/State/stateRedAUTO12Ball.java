...
@Autonomous(name = "state Red AUTO(12ball)", group = "Main")
public class stateRedAUTO12Ball extends OpMode {
    ...
    private final Pose intakeRowThreePos       = new Pose(98.83229813664595, 35.55279503105591, Math.toRadians(0));
    private final Pose intakePickUpRowThreePos = new Pose(138, 35.55279503105591, Math.toRadians(0));
