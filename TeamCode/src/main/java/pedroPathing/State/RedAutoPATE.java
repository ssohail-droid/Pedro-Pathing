...
@Autonomous(name = "Red Autonewtest", group = "Main")
public class RedAutoPATE extends OpMode {
    ...
    private final Pose intakeRowOnePos       = new Pose(95, 89, Math.toRadians(0));
    private final Pose intakePickUpRowOnePos = new Pose(126, 89, Math.toRadians(0));
    private final Pose intakeRowTwoPos       = new Pose(100, 60, Math.toRadians(0));
    private final Pose intakePickUpRowTwoPos = new Pose(131.8, 60, Math.toRadians(0));
    ...
    private void autonomousPathUpdate() {
        switch (pathState) {
            ...
            case 0:
                // TODO: pre-spin / mechanism setup here
            ...
            case 2:
                // TODO: wait for shoot to finish, then:
            ...
            case 4:
                // TODO: run intake here
                if (!follower.isBusy()) {
                    follower.setMaxPower(1);
                    // TODO: stop intake here
