...
public class test extends OpMode {
    ...
    // Spin Servo Positions (HSR-M9382TH 800-2200 Range)
    // 0.0 is now 800us, 1.0 is now 2200us.
    ...
    public void init() {
        ...
        try {
            ...
            if (spin_servo instanceof PwmControl) {
                /* The HSR-M9382TH ignores signals outside 800-2200us.
                   By setting the range here, 0.0 in code = 800us
                   and 1.0 in code = 2200us.
                */
    ...
    public void loop() {
        ...
        telemetry.addData("Spin Target Pos", currentSpinTarget);
        // This confirms the hub is actually sending PWM signals
        if (spin_servo instanceof PwmControl) {
            telemetry.addData("Servo PWM State", ((PwmControl) spin_servo).getPwmRange());
        }
        telemetry.update();
    }
}